...
Blockly.Blocks['FIR.begin'] = {
  init: function() {
    ...
    this.setColour(0);
 this.setTooltip("เชื่อมต่อและรอ Firebase");
 this.setHelpUrl("");
  }
};
...
Blockly.Blocks['FIR.get_string'] = {
  init: function() {
    ...
    this.setColour(0);
 this.setTooltip("รับข้อมูลจากตำแหน่ง");
 this.setHelpUrl("");
  },
  xmlToolbox: function() {
...
Blockly.Blocks['FIR.set'] = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(0);
 this.setTooltip("จัดเก้บข้อมูลไปที่ตำแหน่ง");
 this.setHelpUrl("");
  },
  xmlToolbox: function() {
 		return $(document.createElement('block')).attr({
...
Blockly.Blocks['FIR.delete'] = {
	init: function() {
	    ...
	    this.setNextStatement(true, null);
	    this.setColour(0);
	 	this.setTooltip("ลบข้อมูลที่ตำแหน่ง");
	 	this.setHelpUrl("");
 	},
 	xmlToolbox: function() {
 		return $(document.createElement('block')).attr({
...
Blockly.Blocks["FIR.onvalue"] = {
    init: function() {
        ...
        this.setColour(0);
        this.setTooltip("เมื่อมีข้อมูลจาก path ้เปลี่ยนไปจะทำ");
        this.setHelpUrl("");
    }
};
...
Blockly.Blocks["FIR.value_text"] = {
  init: function() {
    ...
    this.setNextStatement(false);
    this.setColour(0);
    this.setTooltip("ข้อมูลที่เตยได้จาก path");
    this.setHelpUrl("");
  },
  xmlToolbox: function() {
 		return $(document.createElement('block')).attr({
...
Blockly.Blocks["FIR.convert"] = {
  init: function() {
    ...
    this.setNextStatement(false);
    this.setColour(10);
    this.setTooltip("แปลงข้อมูลเป็นตัวเลข ถ้าแปลงไม่ได้จะกลายเป็น 0");
    this.setHelpUrl("");
  },
  // xmlToolbox: function() {
 	// 	return $(document.createElement('block')).attr({
